    ...
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <h1 className="mt-14 text-white text-5xl font-bold leading-tight ">
          Crie seu próprio botão da copa e compartilhe com seus amigos
        </h1>
        ...
        <div className="mt-10 flex items-center gap-2">
          ...
          <strong className="text-gray-100 text-xl">
            <span className="text-ignite-500">+{props.users}</span> pessoas já
            estão usando!
          </strong>
        </div>
        ...
        <footer className="mt-10 pt-10 border-t border-gray-600 flex justify-between text-gray-100">
          ...
          <div className="flex items-center gap-6">
            <Image src={iconCheckImg} alt="" />
            <div className="flex flex-col">
              <span className="font-bold text-2xl">+{props.guesses}</span>
